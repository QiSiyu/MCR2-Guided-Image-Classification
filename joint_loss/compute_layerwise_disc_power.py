...
net = tf.load_prune_model(args.pretrain_dir, args.pretrain_epo, im_shape=im_shape)
net.eval()
...
layers = {'conv1':net.module.conv1,
          ...
          'fin_lin':net.module.final_lin}



disc_powers = []
print("Training set best disc power\tworst\tTest set best\tworst")
